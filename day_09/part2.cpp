...
public:
    ...
    int ExtrapolatePrevious(const std::vector<int>& elems)
    {
        // base case
        ...
        return elems[0] - ExtrapolatePrevious(new_elems);
    }
...
int main()
{
    ...
    for (auto history : solution.histories_)
        result += solution.ExtrapolatePrevious(history);
